...
async function startCrawling(){
  ...
  await page.goto("https://finance.naver.com/item/sise.naver?code=000660")
  await page.waitForTimeout(1000)
  const framePage = await page.frames().find((el) => (el.url().includes("/item/sise_day.naver?code=000660")))
